...
@pytest.mark.asyncio
async def test_async_step_user_success(hass: HomeAssistant, mock_serial_port) -> None:
...
async def test_async_step_user_duplicate_entry(
    hass: HomeAssistant, mock_serial_port
) -> None:
...
@pytest.mark.asyncio
async def test_async_step_usb_discovery(hass: HomeAssistant, mock_serial_port) -> None:
